...
10. VALIDAÇÃO DE DATAS — OBRIGATÓRIA: Antes de usar qualquer data extraída de documento, valide se é uma data de calendário possível. Dia deve ser entre 01 e 31, mês entre 01 e 12, ano deve ser plausível (entre 1900 e 2100). Se qualquer componente for impossível (ex: dia "66", mês "13", ano "9999"), a data é um erro de OCR/leitura — NÃO a use como dado real. Nesse caso: (1) registre "data ilegível — possível erro de OCR" no campo alertas_documentais do documento, (2) NÃO compare essa data com outras fontes como se fosse válida, (3) liste a leitura correta da data como "pendência" nos próximos passos. Exemplos de datas impossíveis: 66/04/2026, 15/13/2025, 00/01/2024.
